...
const formatDetails = {
  ...
  "fashion-fit-check": {
    title: "Проверка, впишется ли вещь в образ",
    explanation: "Помогаем понять до покупки, будет ли вещь работать в вашем гардеробе.",
    firstLook: ["Основной сигнал совместимости", "Один главный риск", "Что может выбиваться по стилю"],
    fullLook: [
    ...
    goodFor: [
      "Сомневаетесь, впишется ли вещь в гардероб",
      "Не хотите купить красивую, но бесполезную вещь",
      "Хотите понять, как она будет смотреться в ваших сочетаниях"
    ]
  }
} as const;
    ...
    <section className="premium-page space-y-6">
      ...
      <header className="premium-page-header">
        ...
        <p className="premium-subtitle">
          Выберите формат: точный подбор размера или проверка, впишется ли вещь в образ. Каждый формат даёт разный тип
