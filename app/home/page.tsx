...
const homeFormats = [
  {
    ...
    fullLook: ["Обязательные / дополнительные / позже", "Логика приоритетов", "Что можно не покупать прямо сейчас"],
  ...
  {
    title: "Практичный сценарий с хранением",
    ...
    <section className="premium-page space-y-6">
      ...
      <div className="premium-section p-6 sm:p-8">
        <div className="premium-note mb-5 p-4 text-sm text-[#5f6c7f]">
          Ниже показаны фиксированные фото-референсы стилей для быстрого выбора направления. В полном результате
          визуал формируется персонально по вашим данным и фото.
        </div>
        <HomeStyleGallery />
      </div>
    </section>
